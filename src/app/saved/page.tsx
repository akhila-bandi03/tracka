...
import { Bookmark, Building, GitCompare, ArrowRight } from 'lucide-react';

export default function SavedPage() {
  const { savedIds } = useCollegeContext();
      ...
      <div className="bg-gradient-to-b from-indigo-950/60 to-slate-950 border-b border-slate-800/80 py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-extrabold text-white">Your Bookmarked Colleges</h1>
            <p className="text-slate-400 text-sm mt-1">
              Keep track of target colleges during counseling and application phases.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="p-12 text-center bg-slate-900/40 rounded-3xl border border-slate-800 max-w-xl mx-auto space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-xl font-bold text-white">No Bookmarked Colleges Yet</h2>
